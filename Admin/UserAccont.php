<?php
   ...
   $fields=("name,DateofBirth,Gender,joined,Designation,email,password");
...
$sql="insert into admin($fields) values('$UserName', '$UserDob', '$Gender', '$datejoin','$Designation', '$UserEmail', '$Password')";
...
<form class="form-horizontal" method="post" action="" name="form2"> 
              ...
              <!-- /.Date changer div Remove this div -->
            ...
            <div class="form-group">
                  <label for="UserName" class="col-sm-3 control-label">User Full Name</label>
...
<div class="col-sm-4">
                <div class="input-group">
                  ...
                  <input type="date" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="" id="UserDob" name="UserDob">
                </div>
                       </div>
                <!-- /.input group -->
                  </div>
                ...
                <div class="form-group">
                  <label for="Date" class="col-sm-3 control-label">Date Joined</label>
...
<div class="col-sm-4">
                <div class="input-group">
                  ...
                  <input type="date" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="" name="datejoin" id="datejoin">
                </div>
                       </div>
                <!-- /.input group -->
                  </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="password" class="form-control" id="Password" name="nic" placeholder="Retype Password">
                  </div>
                </div>
 ...
 <div class="box-footer">
                <input type="submit" value="Insert" name="submit" id="submit" class="btn btn-info pull-right"/>
                </form>
              </div>
