            ...
            <div class="container">
                ...
                <div class="row text-center pad-top-bottom wow bounceIn animated" data-wow-duration="1s" data-wow-delay=".2s">
                    ...
                    <div class="col-lg-4  col-md-4  col-sm-4">
                        <form action="regietrationinsert.php" method="post">
                           ...
                           <div class="form-group">
                                <input type="text" name="Tel" id= "Tel" class="form-control" required placeholder="Contact Number" />
                            </div>
                           ...
                           <div class="form-group">
                             ...
                             <div class="form-group">
                                <input type="password" name="password2" id= "password2" class="form-control" required placeholder="Retype Passsword" />
                            </div>
                            
                            <div class="form-group">
                            
                            
                            <input type="submit" class="btn custom-btn-one" value="Signup">
