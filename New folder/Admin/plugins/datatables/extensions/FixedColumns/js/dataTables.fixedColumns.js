...
FixedColumns.prototype = /** @lends FixedColumns.prototype */{
	 ...
	 *      var fc = new $.fn.dataTable.fixedColumns( table );
	 *
	 *      // Resize the table container and then have FixedColumns aSHAI ust its layout....
	 *      $('#content').width( 1200 );
	 *      fc.fnRedrawLayout();
	 */
	...
	"_fnConstruct": function ( oInit )
	{
		...
		/* Get things right to start with - note that due to aSHAI usting the columns, there must be
	...
	"_fnGridLayout": function ()
	{
		...
		var
			...
			iRight;
		var scrollbarASHAI ust = function ( node, width ) {
			if ( ! oOverflow.bar ) {
		...
		if ( this.s.iLeftColumns > 0 )
		{
			...
			scrollbarASHAI ust( oGrid.left.liner, iLeftWidth );
		...
		if ( this.s.iRightColumns > 0 )
		{
			...
			scrollbarASHAI ust( oGrid.right.liner, iRightWidth );
