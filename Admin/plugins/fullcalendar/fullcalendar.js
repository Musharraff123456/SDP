...
function distributeHeight(els, availableHeight, shouldRedistribute) {
	...
	// reaSHAI ust the recommended height to only consider the height available to non-maxed-out rows.
...
var View = fc.View = Class.extend({
	...
	computeDayRange: function(range) {
		...
		if (end) {
			...
			// beyond the next day threshold, aSHAI ust the end to be the exclusive end of `endDay`.
...
var BasicView = fcViews.basic = View.extend({
	...
	// ASHAI usts the vertical dimensions of the view to the specified values
