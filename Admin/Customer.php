<?php
   ...
   $fields=("Name,Email,Tel,User,password");
...
$sql="insert into member($fields) values('$UserName', '$UserEmail', '$Tel', '$Member', '$Password')";
...
<form class="form-horizontal" method="post" action="" name="form2"> 
            ...
            <div class="form-group">
                  <label for="UserName" class="col-sm-3 control-label">Member Full Name</label>
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="email" class="form-control" id="UserEmail" name="UserEmail" placeholder="Email">
                       ...
                       <div class="form-group">
                  <label for="Tel" class="col-sm-3 control-label">Contact Number</label>
                ...
                <div class="form-group">
                  <label for="Member" class="col-sm-3 control-label">User Name</label>
 ...
 <div class="box-footer">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 Shai Studio.</strong> Designed By Musha
  </footer>
