...
$checkBox = implode(',', $_POST['days']);
 ...
 $sql="insert into Rent(Name,date,item) values('$login_session','$date','" . $checkBox . "')";
...
Select Rent out List Below :  <br />  <br /><input type="checkbox" name="days[]" value="LED MUSIC LASER"> LED MUSIC LASER<br>
  	<input type="checkbox" name="days[]" value="LED BEAMS" checked>LED BEAMS<br>
  	<input type="checkbox" name="days[]" value="BUBBLE MACHINE" checked>BUBBLE MACHINE<br>
  	<input type="checkbox" name="days[]" value="MOVING HEADS" checked>MOVING HEADS<br>
  	<input type="checkbox" name="days[]" value="LED SCANNER" checked>LED SCANNER<br>
  	<input type="checkbox" name="days[]" value="SMOKE" checked>SMOKE<br>
  	<input type="checkbox" name="days[]" value="LASER LIGHTS" checked>LASER LIGHTS<br>
  	<input type="checkbox" name="days[]" value="SOUND LED LIGHT" checked>SOUND LED LIGHT <br>
  ...
  <input type="submit" class="btn custom-btn-one " value="Submit"> <?php echo $error; ?>
