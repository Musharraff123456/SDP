...
$sql="insert into message(Name,Email,Mes) values('$name','$Email','$message')";


if (mysqli_query($conn, $sql)) {
    echo "Your Message was Sent to Shai Production, we will come back to you as soon as possible";
