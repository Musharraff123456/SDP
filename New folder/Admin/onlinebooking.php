            ...
            <div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    ...
                    <input type="text" class="form-control" id="message" name="message" placeholder="Address">
...
<!-- /.box-header -->
     ...
     <input type="text" class="form-control" id="ID1" name="ID1" placeholder="ID1">
    
     <input type="submit" value="Delete" name="Delete2" id="Delete2" class="btn btn-info pull-right"/>
 </form>
                </div>
